...
public class MainComplexityMinimum {
    static int numero_mediciones_por_punto = 10000;
...

	{
		...
		for(int tam = tam_min_monticulo; tam <= tam_min_monticulo + tam_max_monticulo;tam*=2) {
