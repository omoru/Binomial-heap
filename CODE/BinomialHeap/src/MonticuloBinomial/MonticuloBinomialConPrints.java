...
public class MonticuloBinomialConPrints {
	
	private NodoMonticuloBinomial nodos;
	private int n_nodos;

	public MonticuloBinomialConPrints(){
		this.nodos = null;
		this.n_nodos = 0;
	}
	...
	//Retorna el nodo con clave minima del monticulo
	public NodoMonticuloBinomial minimo() {
		if(this.nodos == null) {
	...
	public void borraMin() {
		...
		NodoMonticuloBinomial min_node = this.minimo();
